    ...
    <div className="pl-3 w-full">
      <div className="w-full bg-gray-100 rounded-md px-4 py-2 pb-6">
        <div className="flex gap-2 items-center">
          <label className="text-greenVE-700 text-xl border-0">
            Listar suscriptores
          </label>
          ...
          <div>
            <div className="flex gap-2">
              <div className="w-4/12">
                <label className="text-sm text-greenVE-800 ">
                  Filtrar por:
                </label>
              </div>
            </div>
            <div className="flex gap-2 my-2">
              <input
                ...
                className="w-2/12 h-7 rounded-full"
              ></input>
              <input
                value={ciUsuario}
                onChange={(event) => {
              ...
              ></input>
              <select
                className="p-0 text-xs h-7 rounded-full px-2"
                value={cantidad}
              ...
              <button
                className="bg-greenVE-200 border-2 border-greenVE-600 px-4 rounded-full h-7"
                onClick={() => {
                  handleClickAplicar();
                }}
              >
